# Deploy with mobile improvements

# Stop on errors
$ErrorActionPreference = "Stop"

# Step 1: Build the project
Write-Host "Building project with mobile improvements..." -ForegroundColor Green
npm run build

# Step 2: Create a deployment directory
Write-Host "Preparing deployment directory..." -ForegroundColor Green
$tempDir = "gh-pages-mobile"
...
git checkout -b main
git add -A
git commit -m "Deploy with mobile optimizations"
...
Write-Host "Your mobile-friendly site should be available at: https://grainnem7.github.io/simplified-music-tool/" -ForegroundColor Cyan
